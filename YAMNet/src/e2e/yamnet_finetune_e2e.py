...
def main_cv_e2e(n_folds=5, cfg_obj=fcfg):
    ...
    for fold in range(1, n_folds + 1):
        ...
        from audio_augmentation import expand_with_augmentation
        df_train, fn2wf, X_train, y_train_raw, aug_report = expand_with_augmentation(
            df_train, fn2wf, X_train, y_train_raw,
            target_per_species=15, sr=cfg_obj.SAMPLE_RATE, seed=cfg_obj.SEED + fold)
        # ── 增强结束 ──
